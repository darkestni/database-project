...
public class PhysicalPlanner {
    ...
    private static PhysicalOperator handleDelete(DBManager dbManager, LogicalDeleteOperator logicalDeleteOp) throws DBException {
        // 直接使用 TableScan（安全、简单、干净）
        PhysicalOperator input = handleTableScan(dbManager, new LogicalTableScanOperator(logicalDeleteOp.tableName, dbManager));
        return new DeleteOperator(input, logicalDeleteOp.tableName, logicalDeleteOp.whereExpr);
    }
